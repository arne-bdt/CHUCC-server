...
public class BranchController {
   ...
   *
   * @param name branch name
   * @return no content (501 stub)
   */
  @DeleteMapping("/{name}")
  @Operation(summary = "Delete branch", description = "Delete a branch")
  ...
  /**
   * Reset a branch to a target commit.
   *
   * @param name branch name
   * @param resetRequest reset request
   * @return branch after reset (501 stub)
   */
  @PostMapping(
      value = "/{name}",
      consumes = MediaType.APPLICATION_JSON_VALUE,
