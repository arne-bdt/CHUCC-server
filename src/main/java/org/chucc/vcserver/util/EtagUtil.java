 ...
 *
 * <p>ETags are used for optimistic concurrency control. For branch resources,
...
public final class EtagUtil {
   ...
   *
   * <p>Strong ETags are enclosed in double quotes and indicate that the resource
   ...
   *
   * <p>Removes surrounding quotes if present. Returns null if the input is null.
   *
   ...
   *
   * <p>Parses the ETag and compares it to the expected commit ID.
